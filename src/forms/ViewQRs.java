...
public class ViewQRs extends javax.swing.JFrame {
    ...
    public ViewQRs() {
        initComponents();
         BDUtility.setImage(this, "images/bl.jpg", 876, 577);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(876, 577));
        setMinimumSize(new java.awt.Dimension(876, 577));
        setUndecorated(true);
        ...
        jInternalFrame1Layout.setHorizontalGroup(
            ...
            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblImage, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
                .addContainerGap())
        );
        jInternalFrame1Layout.setVerticalGroup(
            ...
            .addGroup(jInternalFrame1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblImage, javax.swing.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void tblQrListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQrListMouseClicked
        ...
        Image image = icon.getImage().getScaledInstance(258, 271, Image.SCALE_SMOOTH);
